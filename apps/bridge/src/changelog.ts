...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    it: {
      ...
      points: [
        "**CupCat occupa circa 100 MB in meno sul disco**, e fa esattamente le stesse cose. Uno degli strumenti inclusi veniva distribuito avvolto in un runtime di cui non aveva bisogno — 98 MB dove quello ufficiale ne pesa 9 — e quattro copie della stessa libreria erano quattro build diverse. Arriva come aggiornamento dentro l'app — dodici file, circa 164 MB — invece di un installer da 989 MB.",
